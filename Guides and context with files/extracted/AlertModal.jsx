...
export default function AlertModal({ alert, onClose, onResolve }) {
  ...
  const realTrainNumber = alert.real_train_number || alert.raw?.real_train_number || trainId;
  const realStationName = alert.real_station_name || alert.raw?.real_station_name || section;
        ...
        <div style={{padding: '18px'}}>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '14px'}}>
            {[
              ...
              ['Station', realStationName, '#ffffff'],
              ['Train No.', realTrainNumber, '#ffffff'],
            ].map(([label, value, col]) => (
              <div key={label} style={{
